...
(function (root, factory) {
  ...
  var Player = function(parOptions){
    ...
    this._config.size.width = this._config.size.width || (this._config.canvas ? this._config.canvas.width : 0) || 200;
    this._config.size.height = this._config.size.height || (this._config.canvas ? this._config.canvas.height : 0) || 200;
